unit Umain_client_broadtochannel2;
...
begin
  ...
  ChannelManager.RegisterCallback(CallBackID,TMycallBack.create);
end;
...
begin
   ...
   try
     aClient.BroadcastToChannel('MyChannel',TJSONString.Create(Edit1.text));
   finally
     aClient.Free;
   end;
end;
