  ...
  object MainProducer: TPageProducer
    HTMLDoc.Strings = (
      ...
      '<ul>'
        ...
        '   <li><a href="http://localhost/lec/pweb.exe/course"> '#44053#51340#49548#44060' <p><' +
        '/a>'
      
        '   <li><a href="http://localhost/lec/pweb.exe/list"> '#44053#51032#51068#51221' <p></a' +
        '>'
      '   <li><a href="http://localhost/lec/pweb.exe/reg"> '#49688#44053#49888#52397' <p></a>'
      
        '   <li><a href="http://localhost/lec/pweb.exe/chkreg"> '#49688#44053#46321#47197#54869#51064' <p' +
        '></a>'
      
        '   <li><a href="http://localhost/lec/pweb.exe/chkreg"> '#49688#44053#51217#49688#54869#51064' <p' +
        '></a>'
      '   <li><a href="http://localhost/lec/pweb.exe/etc"> Q&A <p></a>'
      '</UL>'
      '<h3>'
      '</center>'
      '</body>'
  ...
  object courseProducer: TPageProducer
    HTMLDoc.Strings = (
      ...
      '     <td valign="left height="16">'
        ...
        '        < a href="http://localhost/lec/pweb.exe"><img src=" ../p' +
        'ic/logo.gif" width=45 height=45 border-0></a><br><br>'
      '     </td>'
      '   </tr>'
      '   <tr>'
