object WebModule1: TWebModule1
  ...
  object MainProducer: TPageProducer
    HTMLDoc.Strings = (
      ...
      '<ul>'
        ...
        '   <li><a href="http://localhost:80/lec/pdatasnap_web.dll/course' +
        '"> '#44053#51340#49548#44060' <p></a>'
      
        '   <li><a href="http://localhost:80/lec/pdatasnap_web.dll/list">' +
        ' '#44053#51032#51068#51221' <p></a>'
      
        '   <li><a href="http://localhost:80/lec/pdatasnap_web.dll/reg"> ' +
        #49688#44053#49888#52397' <p></a>'
      
        '   <li><a href="http://localhost:80/lec/pdatasnap_web.dll/chkreg' +
        '"> '#49688#44053#46321#47197#54869#51064' <p></a>'
      
        '   <li><a href="http://localhost:80/lec/pdatasnap_web.dll/chkreg' +
        '"> '#49688#44053#51217#49688#54869#51064' <p></a>'
      
        '   <li><a href="http://localhost:80/lec/pdatasnap_web.dll/etc"> ' +
        'Q&A <p></a>'
      '</UL>'
      '<h3>'
      '</center>'
  ...
  object courseProducer: TPageProducer
    HTMLDoc.Strings = (
      ...
      '     <td valign="left height="16">'
        ...
        '        < a href="http://localhost:80/lec/pdatasnap_web.dll"><im' +
  ...
  object ListProducer: TPageProducer
    HTMLDoc.Strings = (
      ...
      '    <tr>'
      '      <td valign="left" height="16">'
      '          <a href="http://localhost:80/lec/pdatasnap_web.dll">'
