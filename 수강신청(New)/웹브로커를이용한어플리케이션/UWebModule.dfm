object WebModule8: TWebModule8
  ...
  Actions = <
    ...
    item
      Name = 'WebActionItem3'
      PathInfo = '/Date'
      OnAction = WebModule8WebActionItem3Action
    end
    item
      Name = 'WebActionItem4'
      PathInfo = '/Reg'
      OnAction = WebModule8WebActionItem4Action
    end>
  Height = 367
  Width = 546
  ...
  object MainProducer: TPageProducer
    HTMLDoc.Strings = (
      ...
      '</head>'
      '<body>'
      '<center><img src ="logo.gif height=53 width=397">'
      '<p>'
      '<p>'
      '<h3>'
      '<ul>'
      '   <li><a href="http://localhost:8080/course"> '#44053#51340#49548#44060' <p></a>'
      '   <li><a href="http://localhost:8080/list"> '#44053#51032#51068#51221' <p></a>'
      '   <li><a href="http://localhost:8080/reg"> '#49688#44053#49888#52397' <p></a>'
      '   <li><a href="http://localhost:8080/chkreg"> '#49688#44053#46321#47197#54869#51064' <p></a>'
      '   <li><a href="http://localhost:8080/chkreg"> '#49688#44053#51217#49688#54869#51064' <p></a>'
      '   <li><a href="http://localhost:8080/etc"> Q&A <p></a>'
      '</UL>'
      '<h3>'
      '</center>'
      '</body>'
  ...
  object courseProducer: TPageProducer
    HTMLDoc.Strings = (
      ...
      '     <td valign="left height="16">'
        ...
        '        < a href="http://localhost:8080"><img src=" ../pic/logo.' +
        'gif" width=45 height=45 border-0></a><br><br>'
      '     </td>'
      '   </tr>'
      '   <tr>'
  ...
  object ListProducer: TPageProducer
    HTMLDoc.Strings = (
      ...
      '    <tr>'
      '      <td valign="left" height="16">'
      '          <a href="http://localhost:8080/pweb.exe">'
  ...
  object CurriDateProducer: TDataSetTableProducer
    Columns = <
      item
        FieldName = 'START'
        Title.BgColor = 'Lime'
  ...
  object Query_KindCount: TFDQuery
  ...
  object Query_curriname: TFDQuery
    Connection = FDConnection1
    SQL.Strings = (
      'select * from curri'
      'where kind =:p_kind')
