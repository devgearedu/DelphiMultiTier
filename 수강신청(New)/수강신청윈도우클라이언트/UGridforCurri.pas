...
uses
  ...
  Dialogs, StdCtrls, Grids, DBGrids, ExtCtrls, ComCtrls, DBCtrls, Spin, Data.DB;
...
begin
  Dm.query_CurriList.Close;
  Dm.query_CurriList.ParamByName('p_code').AsString :=
  DbLookupCombobox1.KeyValue + '%';
  Dm.query_CurriList.ParamByName('p_date1').AsDate := trunc(datetimepicker1.Date);
  Dm.query_CurriList.ParamByName('p_date2').AsDate := trunc(datetimepicker2.Date);
  Dm.query_CurriList.Open;
end;
...
procedure TForm_GridforCurri.FormCreate(Sender: TObject);
begin
