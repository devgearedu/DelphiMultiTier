...
begin
  ...
  btnNext.Enabled := (not (state in [TMPPlaybackState.Stopped])) and TMusicPlayer.DefaultPlayer.CanSkipForward;
  btnPrev.Enabled := (not (state in [TMPPlaybackState.Stopped])) and TMusicPlayer.DefaultPlayer.CanSkipBack;
end;
