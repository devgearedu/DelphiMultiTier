  ...
  object MainProducer: TPageProducer
    HTMLDoc.Strings = (
      ...
      '<ul>'
        ...
        '   <li><a href="http://localhost:81/lec/pdatasnap.dll/course"> '#44053 +
        #51340#49548#44060' <p></a>'
      
        '   <li><a href="http://localhost:81/lec/pdatasnap.dll/list"> '#44053#51032#51068 +
        #51221' <p></a>'
      
        '   <li><a href="http://localhost:81/lec/pdatasnap.dll/reg"> '#49688#44053#49888#52397 +
        ' <p></a>'
      
        '   <li><a href="http://localhost:81/lec/pdatasnap.dll/chkreg"> '#49688 +
        #44053#46321#47197#54869#51064' <p></a>'
      
        '   <li><a href="http://localhost:81/lec/pdatasnap.dll/chkreg"> '#49688 +
        #44053#51217#49688#54869#51064' <p></a>'
      
        '   <li><a href="http://localhost:81/lec/pdatasnap.dll/etc"> Q&A ' +
        '<p></a>'
      '</UL>'
      '<h3>'
      '</center>'
