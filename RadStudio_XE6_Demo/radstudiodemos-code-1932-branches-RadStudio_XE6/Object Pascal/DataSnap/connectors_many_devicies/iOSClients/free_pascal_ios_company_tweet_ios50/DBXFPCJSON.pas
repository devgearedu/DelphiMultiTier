...
{$ENDIF}
  ...
  public
    ...
    *)
    function GetInternalObject: TObject; virtual; abstract;
    (* *
      ...
      * @return
    *)
    function GetJsonValueType: FPJSONValueType; virtual; abstract;
    (* *
  ...
  public
    function GetInternalObject: String; overload;
...
{$ENDIF}
  ...
  public
    function GetInternalObject: Double; overload;
    function GetJsonValueType: FPJSONValueType; override;
    function ToString: String; override;
  ...
  public
    function GetInternalObject: Boolean; overload;
    function GetJsonValueType: FPJSONValueType; override;
    function ToString: String; override;
  ...
  public
    function GetInternalObject: variant; overload;
    function GetJsonValueType: FPJSONValueType; override;
    function ToString: String; override;
    function asJSONString: String;
  end;
