...
var
  LRepeatMode: TMPRepeatMode;
begin
  LRepeatMode := TMPRepeatMode(FMusicPlayer.repeatMode);
  case LRepeatMode of
    TMPRepeatMode.Default,
    TMPRepeatMode.None: Result := FMusicPlayer.indexOfNowPlayingItem > Low(FPlaylist);
    TMPRepeatMode.One,
    TMPRepeatMode.All: Result := True;
  end;
end;
...
begin
  ...
  case LRepeatMode of
    TMPRepeatMode.Default,
    TMPRepeatMode.None: Result := FMusicPlayer.indexOfNowPlayingItem < High(FPlaylist);
    TMPRepeatMode.One,
    TMPRepeatMode.All: Result := True;
  end;
end;
